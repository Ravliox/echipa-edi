<template>
    <figure class="snip1167">
        <img :src="testimContent.author.img" alt="sq-sample3"/>
        <blockquote>{{testimContent.quote}}</blockquote>
        <div class="author">
            <h5>{{testimContent.author.name}} <span> {{testimContent.author.description}}</span></h5>
        </div>
    </figure>
</template>
